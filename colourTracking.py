...
import time
import cv2
#from depthCameraToRealWorld import DepthCamera
...
def getCenterOfGripper(originalFrame):
    
    blueLower = np.array([0, 200, 200], dtype = "uint8")
    blueUpper = np.array([10, 255, 255], dtype = "uint8")
...
#            print(c)
            cv2.drawContours(frameCopy, [p_rect], -1, (0, 255, 0), 2)
        ...
        putTextWrap(frameCopy,'Center',allCenter_pixel)
...
#        print(allCenter)
        ...
        return allCenter_pixel,frameCopy
