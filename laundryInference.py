...
class Inference():
  ...
  # was constantly changin the visualization, so I decided to reload it instead of notebook
...
if __name__== "__main__":
    ...
    myCam = depthCameraToRealWorld.DepthCamera()
    counter = 0
    cordList = []
    while True:
        image,depthImage = myCam.getRGBAndDepthFrame()
    
        results = myInference.model.detect([image], verbose=1)
